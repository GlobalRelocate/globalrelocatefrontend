...
export default function VisaIndexCard() {
  const [hoveredImage, setHoveredImage] = useState(
    "/images/landing/visa-index-1.png"
  );
  const { t } = useTranslation();

  const items = [
    {
      title: t("landingPage.features.visaIndex.item1.title"),
      icon: <i className="far fa-passport text-[#FCA311] text-2xl" />,
      para: t("landingPage.features.visaIndex.item1.para"),
      image: "/images/landing/visa-index-1.png",
    },
    {
      title: t("landingPage.features.visaIndex.item2.title"),
      icon: <i className="far fa-passport text-[#FCA311] text-2xl" />,
      para: t("landingPage.features.visaIndex.item2.para"),
      image: "/images/landing/visa-index-2.png",
    },
  ];
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-x-24 gap-y-12 p-4 mt-12">
      ...
      <div className="flex flex-col gap-6">
        <h3 className="text-2xl font-semibold">
          {t("landingPage.features.visaIndex.title")}
        </h3>
        {items.map((item, index) => (
          <div
            ...
            onMouseLeave={() =>
              setHoveredImage("/images/landing/visa-index-1.png")
            }
          >
